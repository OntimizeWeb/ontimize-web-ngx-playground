export class MockData {
  ...
  public static percentagesArray = [{
    percentageCode: 16,
    percentageValue: "16"
  }, {
    percentageCode: 23,
  ...
  public static translationsArray = [{
    itemCode: 0,
  ...
  public static selectedCountriesCode = [1, 2];

  public static selectedIntegerCode = 2;

  public static selectedIntegerValues = [1, 2];

  public static selectedDateCode = 3;

  public static selectedPercentageCode = 16;

  public static selectedBooleanCode = 1;
