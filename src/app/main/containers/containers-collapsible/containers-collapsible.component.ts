...
</o-{layout}-collapsible>
`;

const TYPESCRIPT_DATA = ``;

@Component({
  selector: 'containers-collapsible',
  templateUrl: './containers-collapsible.component.html',
  styleUrls: ['./containers-collapsible.component.scss'],
  host: {
    '[class.containers-collapsible]': 'true'
  }
})
export class ContainersCollapsibleComponent {
