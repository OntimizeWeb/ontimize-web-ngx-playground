...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'grid', loadChildren: () => import('./data/grid/grid.module').then(m => m.GridModule) },
      { path: 'home', loadChildren: () => import('./home/home.module').then(m => m.HomeModule) },
      { path: 'inputs', loadChildren: () => import('./inputs/inputs.module').then(m => m.InputsModule) },
      { path: 'lists', loadChildren: () => import('./data/lists/lists.module').then(m => m.ListsModule) },
      ...
      { path: 'table', loadChildren: () => import('./data/table/table.module').then(m => m.TableModule) },
