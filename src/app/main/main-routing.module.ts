...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'contextmenu', data: { oAppHeaderTitle: 'Context menu component' }, loadChildren: () => import('./contextmenu/context-menu.module').then(m => m.ContextMenuModule) },
      { path: 'dialogs', data: { oAppHeaderTitle: 'Dialog component' }, loadChildren: () => import('./dialogs/dialogs.module').then(m => m.DialogsModule) },
      { path: 'grid', loadChildren: () => import('./grid/grid.module').then(m => m.GridModule) },
      { path: 'home', data: { oAppHeaderTitle: 'Home' }, loadChildren: () => import('./home/home.module').then(m => m.HomeModule) },
      ...
      { path: 'snackbar', data: { oAppHeaderTitle: 'Snackbar component' }, loadChildren: () => import('./snackbar/snackbar.module').then(m => m.SnackBarModule) },
      { path: 'table', loadChildren: () => import('./table/table.module').then(m => m.TableModule) },
      { path: 'tooltip', data: { oAppHeaderTitle: 'Tooltip component' }, loadChildren: () => import('./tooltip/tooltip.module').then(m => m.TooltipModule) },
