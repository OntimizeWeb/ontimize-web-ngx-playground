...
const COMBO_HTML_DATA = `
  <o-form editable-detail="false" show-header="no" layout-direction="column">
    ...
    <div fxLayout="row" fxLayoutGap="8px">
      ...
      <o-combo attr="combo-editable-search" label="{{ 'INPUT.COMBO.SEARCH' | oTranslate }} - Custom Render" [static-data]="getDataArray()" [data]="getValueSimple()"
...
const COMBO_HTML_DATA_MULTIPLE = `
  <o-form editable-detail="false" show-header="no" layout-direction="column">
    ...
    <div fxLayout="row" fxLayoutGap="8px">
      ...
      <o-combo attr="combo-editable-multiple-search" label="{{ 'INPUT.COMBOMULTIPLE.SEARCH' | oTranslate }} - Custom Render" [static-data]="getDataArray()"
...
@Component({
  selector: 'input-combo-custom-render',
  templateUrl: './input-combo-custom-render.component.html'
})
...
export class InputComboCustomRenderComponent {
