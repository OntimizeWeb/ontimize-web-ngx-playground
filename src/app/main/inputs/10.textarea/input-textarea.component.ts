...
const TEXTAREA_HTML_DATA = `
  <o-form editable-detail="no" show-header="no" layout-direction="column">
    ...
    <o-textarea-input attr="textarea" label="Textarea" [data]="textArea" rows="10"></o-textarea-input>

    <o-textarea-input attr="textarea2" label="Textarea" [data]="textArea" read-only="no" rows="10" ></o-textarea-input>

    <o-textarea-input attr="textarea3" label="Textarea" enabled="no" [data]="textArea" rows="10"></o-textarea-input>
